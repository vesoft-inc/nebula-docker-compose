...
| [`v3.0`](https://github.com/vesoft-inc/nebula-docker-compose/tree/v3.0)                       | `v3.0` of the [nebula](https://github.com/vesoft-inc/nebula) repository | v3.0.x | [Deploy Nebula Graph with Docker Compose](https://docs.nebula-graph.io/2.0/2.quick-start/2.deploy-nebula-graph-with-docker-compose/) |
